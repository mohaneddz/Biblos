                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      label: "Ornithischia",
                      rank: "Clade",
                      description: "\"Bird-hipped\" dinosaurs — mostly herbivorous, including the horned, armored, and duck-billed groups like Triceratops and Stegosaurus.",
                      wikiTitle: "Ornithischia",
                      icon: "reptile",
                      scope: { order: "Ornithischia" },
                    },
                    {
                      id: "saurischia",
                      label: "Saurischia",
                      rank: "Clade",
                      description: "\"Lizard-hipped\" dinosaurs, spanning the giant long-necked sauropods and the theropods — including Tyrannosaurus, Velociraptor, and, cladistically, modern birds.",
                      wikiTitle: "Saurischia",
                      icon: "reptile",
                      scope: { order: "Saurischia" },
                    },
                  ],
                },
                {
